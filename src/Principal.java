public class Principal {
    ...
    Alumno alumno = new Alumno();
        Alumno alumno8 = new Alumno("Paco","a",1);
        Alumno alumno1 = new Alumno("Mario","b",10);
        Alumno alumno2 = new Alumno("Juan","c",4);
        Alumno alumno3 = new Alumno("Luis","d",6);
        Alumno alumno4 = new Alumno("Jorge","e",8);
        Alumno alumno5 = new Alumno("Javi","Andaluz",10);
        Alumno alumno6 = new Alumno("Ana","g",2);
        Alumno alumno7 = new Alumno("Nana","h",1);
